...
def search_view_ext(request, path=None, search_pattern=None, as_json=False):
	...
	return search_view(request, contrib.get_full_path(document_root, path), path, search_pattern, as_json)


def search_view(request, folder, url, search_pattern, as_json=False):
	searches = {}
	...
	return render_to_response(
		...
		{ 'searches': searches, 'search_pattern': search_pattern },
